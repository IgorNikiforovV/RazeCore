...
public class RazeCore {
    /// Allows to convert a 6 digit hexadecimal string into a UIColor instance
    /// - Warming: The "#" symbol is stripped from beginning of the string submitted here.
    /// - Parameters:
    ...
    ///   - alpha: A number between 0.0 and 1.0 indicating how how transparent the color is
    /// - Returns: A UIColor defined the 'hexString' parameter
    ...
    public static var razeColor: UIColor {
        self.colorFromHexString("006736")
    }

    /// Returns an objects 'UIColor' with the second most eye-pleasing color known to all humanity
